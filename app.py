...
def buscar_imagens(tema, estilo):
    ...
    # Embaralha para evitar sempre a mesma sequência
    palavras_visuais = visuais.copy()
    random.shuffle(palavras_visuais)

    # --------------------------------------------------------
    # PRIMEIRA TENTATIVA:
    # TEMA + CONTEXTO VISUAL
    # --------------------------------------------------------
...
def criar_video(
    ...
    # Agora as imagens são buscadas
    # de acordo com o tema + categoria
